                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-md border border-zinc-800 bg-zinc-900/50 px-4 py-2 text-sm text-white placeholder:text-zinc-500 focus:border-[#4cc9f0] focus:outline-none"
                      />
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                    <div>
                      ...
                      <p className="text-sm text-zinc-400">
                        Get notified when a new student enrolls in a course
                      </p>
                    </div>
                    <label className="relative inline-flex cursor-pointer items-center">
                      ...
                      />
                      <div className="h-6 w-11 rounded-full bg-zinc-700 after:absolute after:left-[2px] after:top-[2px] after:size-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-[#4cc9f0] peer-checked:after:translate-x-full peer-focus:outline-none"></div>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center justify-between rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                    <div>
                      ...
                      <p className="text-sm text-zinc-400">
                        Get notified when a student completes a course
                      </p>
                    </div>
                    <label className="relative inline-flex cursor-pointer items-center">
                      <input
                  ...
                  <div className="flex items-center justify-between rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                    <div>
                      ...
                      <p className="text-sm text-zinc-400">
                        Get notified about new payments and subscriptions
                      </p>
                    </div>
                    <label className="relative inline-flex cursor-pointer items-center">
                      <input
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="flex size-10 items-center justify-center rounded-md bg-[#1da1f2]/10">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="rounded-full bg-emerald-900/30 px-2 py-1 text-xs font-medium text-emerald-500">
                          Connected
                        </span>
                        <button className="text-xs text-[#4cc9f0]">
                          Configure
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="flex size-10 items-center justify-center rounded-md bg-[#ea4335]/10">
                      ...
                      <div className="flex items-center gap-2">
                        <button className="rounded-md bg-[#4cc9f0]/20 px-3 py-1 text-xs font-medium text-[#4cc9f0]">
                          Connect
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="flex size-10 items-center justify-center rounded-md bg-[#4a154b]/10">
