...
const CreateCoursePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // First prepare the form data for the image upload
      const formData = new FormData();

      // If we have a file, use it; otherwise, use a placeholder
      if (thumbnailFile) {
        formData.append("thumbnail", thumbnailFile);
        formData.append("courseId", "temp-" + Date.now()); // Temporary ID until we have the real course ID
      }
      ...
      if (thumbnailFile) {
        ...
        thumbnailUrl = imageUploadResponse.url;
      }

      // Then create the course with the thumbnail URL
